...
// to slide up text
let textUpScroll = (trigger, scroller) => {
    gsap.to(`${trigger}`, {
        scrollTrigger: {
            trigger: `${trigger}`,
            scroller: `${scroller}`,
...
//page 1
pin("#page1", "#main");
shadow("#page1>video", "#main")
textUpScroll("#page1>h1", "#main");

//page 2
pin("#page2", "#main");
shadow("#page2>video", "#main")
textUpScroll("#page2>h1", "#main");

//page 4

pin("#page4", "#main");
shadow("#page4>video", "#main")
textUpScroll("#page4-text", "#main");
//  pjage4-1
pin("#page4-1", "#main");
shadow("#page4-1>video", "#main")
textUpScroll("#page4-1-text", "#main");
// page4-2
pin("#page4-2", "#main");
shadow("#page4-2>video", "#main")
textUpScroll("#page4-2-text", "#main");
// page4-3
pin("#page4-3", "#main");
shadow("#page4-3>video", "#main")
textUpScroll("#page4-3-text", "#main");
...
let flashText = (trigger) => {
    gsap.to(trigger, {
        ...
        scrollTrigger: {
            ...
            onEnter: () => {
                // When the element enters the trigger range, set opacity to 1
                gsap.set(trigger, { opacity: 1 });
            },
            onLeave: () => {
                // When the element leaves the trigger range, set opacity back to 0
                gsap.to(trigger, { opacity: 0 });
            },
            scrub: 3,
        },
    });
...
// page17
pin("#page17", "#main");
shadow("#page17>video", "#main")
textUpScroll("#page17-text", "#main");
...
glowing("#page23>#img1",0);
glowing("#page24>#img1",0);
glowing("#page25>#img1" ,1);